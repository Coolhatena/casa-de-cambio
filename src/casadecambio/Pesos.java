...
public class Pesos extends Transaccion{
	...
	public float[] cambiar(float pesos, float euros, float dolares, float tipoCambioD, float tipoCambioE ) {
		...
		do {
			System.out.println("Ha que divisa deseas convertir tus Pesos?");
			System.out.println("1: Euros, 2: Dolares");
			opcion = leer.nextInt();
